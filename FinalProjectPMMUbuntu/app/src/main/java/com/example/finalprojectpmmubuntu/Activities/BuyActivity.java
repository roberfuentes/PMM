...
import com.example.finalprojectpmmubuntu.Fragments.FragmentBuy;
...
public class BuyActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mSpinnerQuantity = (Spinner)findViewById(R.id.spnQuantity);
        ArrayAdapter<Integer> spnAdapter = new ArrayAdapter<Integer>(BuyActivity.this, R.layout.support_simple_spinner_dropdown_item, quantity);
        mSpinnerQuantity.setAdapter(spnAdapter);
